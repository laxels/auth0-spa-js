...
var u = function (e) {
  ...
  B = d(function () {
    ...
    ? function (e) {
        return 'String' == h(e) ? m.call(e, '') : Object(e);
      }
    : Object,
  F = function (e) {
  ...
  Q = {
    f: g
      ...
      : function (e, t) {
          ...
          if (C(e, t)) return p(!y.f.call(e, t), e[t]);
        }
  },
  A = function (e) {
...
var E,
  ...
  j = function (e) {
    return (
      'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++z + _).toString(36)
    );
  },
  P = D('keys'),
  M = function (e) {
...
var oe,
  ...
  se = a(function (e) {
    ...
    (e.exports = function (e, t, r, o) {
      var c = !!o && !!o.unsafe,
        ...
        a = !!o && !!o.noTargetGet;
      'function' == typeof r &&
        ('string' != typeof t || C(r, 'name') || W(r, 'name', t),
  ...
  Fe = function (e, t) {
    var n,
      ...
      r = 0,
      o = [];
    for (n in i) !C(q, n) && C(i, n) && o.push(n);
    for (; t.length > r; ) C(i, (n = t[r++])) && (~Be(o, n) || o.push(n));
    return o;
  },
  Ue = [
    'constructor',
  ...
  Ze = function (e, t) {
    for (var n = Ce(t), i = L.f, r = Q.f, o = 0; o < n.length; o++) {
      var c = n[o];
      C(e, c) || i(e, c, r(t, c));
    }
  },
  ...
  Ye = function (e) {
    return (
      C(ke, e) ||
        (Je && C(Ee, e) ? (ke[e] = Ee[e]) : (ke[e] = Te('Symbol.' + e))),
      ke[e]
    );
  },
  Ne = Ye('match'),
  Ke = function (e) {
    if (
      (function (e) {
        var t;
        return V(e) && (void 0 !== (t = e[Ne]) ? !!t : 'RegExp' == h(e));
      })(e)
    )
  ...
  je = Math.min,
  Pe = De('startsWith'),
  Me = !(Pe || ((oe = ze(String.prototype, 'startsWith')), !oe || oe.writable));
We(
...
var ft,
  ...
  ht = le('document', 'documentElement'),
  mt = M('IE_PROTO'),
  Bt = function () {},
  Ft = function (e) {
...
var Vt =
  ...
  Ct = function (e, t, n) {
    e &&
      !C((e = n ? e : e.prototype), St) &&
      vt(e, St, { configurable: !0, value: t });
  },
  Zt = {},
  ...
  Lt = function (e, t, n, i, r, o, c) {
    !(function (e, t, n) {
      var i = t + ' Iterator';
      (e.prototype = Vt(Xt, { next: p(1, n) })), Ct(e, i, !1), (Zt[i] = wt);
    })(n, t, i);
    var s,
      a,
      u,
    ...
    if (
      (b &&
        ...
        Rt !== Object.prototype &&
          s.next &&
          (dt(s) !== Rt &&
            (Gt ? Gt(s, Rt) : 'function' != typeof s[At] && W(s, At, xt)),
          Ct(s, d, !0))),
      'values' == r &&
        f &&
        'values' !== f.name &&
      ...
      if (
        ...
        for (u in a) (Qt || g || !(u in I)) && se(I, u, a[u]);
      else We({ target: t, proto: !0, forced: Qt || g }, a);
    return a;
  },
  Wt = ct.charAt,
  Jt = ce.set,
...
var rn,
  ...
  mn = function (e) {
    return V(e) && C(hn, _t(e));
  };
for (rn in hn) l[rn] || (bn = !1);
if (
  (!bn || 'function' != typeof dn || dn === Function.prototype) &&
  ((dn = function () {
    throw TypeError('Incorrect invocation');
  }),
  bn)
)
  for (rn in hn) l[rn] && Gt(l[rn], dn);
if ((!bn || !gn || gn === In) && ((gn = dn.prototype), bn))
  for (rn in hn) l[rn] && Gt(l[rn].prototype, gn);
if ((bn && dt(ln) !== gn && Gt(ln, gn), g && !C(gn, yn)))
  for (rn in (!0,
  cn(gn, yn, {
    get: function () {
  ...
  Un = function (e, t, n) {
    if (g) {
      if (n)
        for (var i in hn) {
          var r = l[i];
          r && C(r.prototype, e) && delete r.prototype[e];
        }
      (gn[e] && !n) || se(gn, e, n ? t : (bn && an[e]) || t);
    }
  },
  Vn = Ye('species'),
  vn = Bn,
...
Un(
  ...
  function (e, t) {
    for (
      var n = Cn.call(vn(this), e, t),
        i = (function (e, t) {
          var n,
            i = A(e).constructor;
          return void 0 === i || null == (n = A(i)[Vn]) ? t : tt(n);
...
var wn = function (e) {
  ...
  An = me.includes,
  xn = (function (e, t) {
    if (C(Rn, e)) return Rn[e];
    t || (t = {});
    var n = [][e],
      i = !!C(t, 'ACCESSORS') && t.ACCESSORS,
      r = C(t, 0) ? t[0] : Qn,
      o = C(t, 1) ? t[1] : void 0;
    return (Rn[e] =
      !!n &&
      !d(function () {
        if (i && !g) return !0;
        var e = { length: -1 };
        i ? Gn(e, 1, { enumerable: !0, get: Qn }) : (e[1] = 1), n.call(e, r, o);
      }));
  ...
  Wn = a(function (e) {
    var t = L.f,
      ...
      c = (e.exports = {
        ...
        onFreeze: function (e) {
          return Ln && c.REQUIRED && r(e) && !C(e, n) && o(e), e;
        }
      });
    q[n] = !0;
  }),
          ...
          case 6:
            ...
            if (
              ...
              throw (
                ...
                ((b = new Error(p)).error = I || 'request_error'),
                (b.error_description = p),
                b)
              );
            return [2, y];
        }
  ...
  Ir = (function () {
    ...
    return (
          ...
          return o(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                return n.sent(), [3, 4];
              case 3:
                if (((t = n.sent()), !hi.includes(t.error))) throw t;
                return [3, 4];
              case 4:
                return [2];
            }
      ...
      (e.prototype._getTokenFromIFrame = function (e) {
        return r(this, void 0, void 0, function () {
          var t, r, c, s, a, u, l, d, g, I, f, y, p, b;
          return o(this, function (o) {
            switch (o.label) {
              case 0:
              ...
              case 3:
                return (
                  (p = o.sent()),
                  (b = this._verifyIdToken(p.id_token, r)),
                  [
                    2,
                    n(n({}, p), {
                      decodedToken: b,
